...
namespace TestFlujoWebServiceSOAT
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string placa = "1529ISS";
            int canalVenta = 28;
            int gestionFk = 2019;
            int medioPago = 29;
            oCeSeg01Autenticacion.Contrasenia = "Univida123+";
            ...
            */
            ...
            if (resCSVen04Listar.Exito)
            {
                ...
                Console.WriteLine("NRO_COMPROBANTE|PLACA|NO_AUT_FACTURA|NUM_FACTURA|FECHA_FACTURA|PRIMA|ESTADO");
                foreach (var detalleVenta in datosVentas.lSoatDatosVenta)
                {
                    Console.WriteLine(String.Format("{0}|{1}|{2}|{3}|{4}|{5}|{6}", new object[] { detalleVenta.SoatNroComprobante, detalleVenta.VehiPlaca, detalleVenta.FactAutorizacionNumero, detalleVenta.FactNumero, detalleVenta.FactFecha,detalleVenta.FactPrima, detalleVenta.SoatTParGenericaEstadoFk.ToString() }));
                }
            }
