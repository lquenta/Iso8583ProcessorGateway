...
namespace Cerberus.ATC.GatewayV2Service
{
    ...
    class SOATProcessor
    {
        ...
        public int medioPago = Int32.Parse(System.Configuration.ConfigurationManager.AppSettings["medioPago"]);
        public int canalVenta = Int32.Parse(System.Configuration.ConfigurationManager.AppSettings["canalVenta"]);
        public int gestionFk = Int32.Parse(System.Configuration.ConfigurationManager.AppSettings["gestion"]);
        ...
        public string ProcesarMensaje()
        {
            ...
            switch (ParsedMsgReq[3])
            {
                ...
                case "040000": //enrolado y calculo de prima
                    ...
                    int gestionFkElegido = Int32.Parse(datosAutomovil[1]);
                    if (gestionFkElegido != 1)
                    {
                        gestionFk = gestionFk-1;
	                }
                ...
                case "060000": //solicitud de listado de venta
                    ...
                    if (strCampo63[0].Trim() != "")
                    {
                        fechaBusqueda = DateTime.ParseExact(strCampo63[0], "dd-MM-yyyy", System.Globalization.CultureInfo.InvariantCulture);  //fecha
                    }
                    placa = "";
                    if (strCampo63[1].Trim() != "")
                    {
                        placa = strCampo63[1]; //
                    }
                    ...
                    //resMensaje = messageHex;
                    resMensaje = hexTPDU + listarVentas(placa, fechaBusqueda, Int32.Parse(token));
                    break;
        ...
        public string ObtenerFacturaComprobante(int token, int comprobante)
        {
            ...
            catch (Exception ex)
            {
                ...
                string[] messageRespuesta = new string[130];
                    ...
                    string nonASCIIsection = "";
                    resMensaje = msgIso8583.BuildCustomISO(messageRespuesta, MTI, out nonASCIIsection);
                    logger.Error("Error en la obtencion de la factura:" + ex.Message);
            }
            return resMensaje;
        ...
        public string listarVentas(string placa,DateTime fecha,int token)
        {
            ...
            try
            {
                ...
                reqCEVen04Listar.SoatTParGestionFk = gestionFk;
                ...
                reqCEVen04Listar.VehiPlaca = placa;
            ...
            catch (Exception ex)
            {
                ...
                resMensaje = msgIso8583.BuildCustomISO(messageRespuesta, MTI, out nonASCIIsection);
                logger.Error("Error obtencion listado de ventas :" + ex.Message);
            }
